...
I am a Data-Driven Developer specializing in building scalable **Spring Boot** applications and transforming complex clinical datasets into actionable insights. My focus is bridging the gap between robust backend systems and high-impact analytical platforms.

- 🏥 **Healthcare Systems:** Expert in extracting and analyzing clinical data from **Epic (Clarity & Caboodle)** modules.
- 🔐 **Compliance First:** Dedicated to maintaining data integrity and patient privacy through strict adherence to **HIPAA** and **HITRUST** standards.
- 🛠 **Data Architect:** Building scalable ETL pipelines with **Azure Data Factory** and optimized **Power BI** dashboards.
